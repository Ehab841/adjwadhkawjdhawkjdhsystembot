...
setInterval(() => {
  http.get(`http://blackcloudsystem.glitch.me/`);
}, 280000);
...
client.on("ready", () => {
  ...
  client.user.setActivity(`${prefix}help | BlackCloud`, { type: "WATCHING" });
});
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "new")) {
    const reason = message.content
      ...
      .slice(1)
      .join(" ");
    if (!message.guild.roles.exists(gg => gg.name === "↬  Discord Helper's"))
      return message.channel.send(`لازم تسوي رتبة اسمها \`↬  Discord Helper's\`.`);
    if (
    ...
    message.guild
      ...
      .then(c => {
        let role = message.guild.roles.find(gg => gg.name === "↬  Discord Helper's");
        ...
        const embed = new Discord.RichEmbed()
          ...
          .addField(
            ...
            `يرجى محاولة شرح سبب فتح هذه التذكرة بأكبر قدر ممكن من التفاصيل. سيتواجد ** فريق الدعم ** لدينا قريبًا للمساعدة | **BlackCloudTeam**.`
          )
          .setTimestamp();
        c.send({
          embed: embed
    ...
    if (
      !message.member.roles.has(
        message.guild.roles.filter(r => r.name === "↬  Discord Helper's").first().id
      )
    )
      return message.channel.send("You don't have the `↬  Discord Helper's` role!");
    message.channel
      .delete()
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@540937662257692672>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
    ...
    client
      ...
      .then(user => {
        ...
        let avtEmbed = new Discord.RichEmbed()
          ...
          .setFooter(`AvatarSystem`, message.client.user.avatarURL);
        ...
        .then(collected => {
          ...
          message.channel
            ...
            .then(async collectedd => {
              ...
              embed1.setFooter(
                `اعدادات رد تلقائي لدي بلاك كلاود`,
              );
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "تقديم")) {
    if (!message.channel.guild) return;
    if (message.author.bot) return;
    let channel = message.guild.channels.find(gg => gg.name === "التقديم-على-الادارة︲🔰");
    if (!channel)
      return message.reply(
        "**لانشاء روم التقديم-على-الادارة︲🔰 ${prefix}room1 من فضلك اكتب الامر**"
      );
    if (channel) {
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "room1")) {
    ...
    message.guild.createChannel("التقديم-على-الادارة︲🔰", "text").then(c => {
      c.overwritePermissions(message.guild.id, {
        SEND_MESSAGES: false
      });
    });
    message.channel.send("**✅ تم انشاء روم التقديم-على-الادارة︲🔰 بنجاح**");
  }
});
